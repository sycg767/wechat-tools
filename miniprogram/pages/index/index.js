...
const TOOL_DEFS = [
  ...
  },
  {
    ...
    path: '/pages-doc/csv-excel/index',
  ...
  },
  {
    ...
    path: '/pages-doc/pdf-merge/index',
  ...
  },
  {
    ...
    title: 'PDF 拆分',
    desc: '提取 PDF 指定页面',
    path: '/pages-doc/pdf-split/index',
  ...
  },
  {
    ...
    title: 'PDF 水印',
    desc: '为 PDF 添加或去除水印',
    path: '/pages-doc/pdf-watermark/index',
  ...
  },
  {
    ...
    title: 'PDF 页面管理',
    desc: '页面重排、旋转、删除',
    path: '/pages-doc/pdf-manage/index',
  ...
  },
  {
    ...
    title: '证件照换底色',
    desc: '上传人像照片并切换红蓝白背景',
    path: '/pages-tool/id-photo-bg/index',
  ...
  },
  {
    id: 'pdf-sign',
    title: 'PDF 电子签字',
    desc: '在 PDF 任意位置盖手写签名',
    path: '/pages-tool/pdf-sign/index',
    iconClass: 'icon-signature',
    tag: '新增',
    category: '文档处理',
    order: 90,
    svgPath: 'M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z M14 2v6h6 M16 18l-2-2-3 3-1-1-2 2'
  },
  {
    id: 'md-export',
    title: 'Markdown 转换',
    desc: '一键导出 PDF 或 Word 文档',
    path: '/pages-tool/md-export/index',
    iconClass: 'icon-pdf-word',
    tag: '新增',
    category: '文档处理',
    order: 100,
    svgPath: 'M3 5h18v14H3z M7 9l3 3 3-3 M14 14h4 M14 10h4'
  },
  {
    id: 'dev-toolkit',
    title: '开发者工具箱',
  ...
  },
  {
    ...
    title: '答案之书',
    desc: '人生翻翻看，给你一句方向',
    path: '/pages-fun/book-answer/index',
    iconClass: 'icon-random',
    tag: '热门',
    category: '轻娱乐',
    order: 2,
  ...
  },
  {
    ...
    title: '电子木鱼',
    desc: '赛博功德，解压神器',
    path: '/pages-fun/wooden-fish/index',
  ...
  },
  {
    ...
    title: '王者计分',
    desc: '记录迟到、输赢与下播荣辱',
    path: '/pages-king/king-score/index',
    iconClass: 'icon-eat',
    tag: '核心',
    category: '游戏工具',
    order: 1,
